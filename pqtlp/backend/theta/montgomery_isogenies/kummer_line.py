...
from sage.all import EllipticCurve, Integer, cached_method
...
class KummerPoint:
    def __init__(self, parent, coords):
        ...
        # Membership in the elliptic curve is checked when lifting the point.
        self._base_ring = R
        self._parent = parent
    ...
    def x(self):
        """Return the affine x-coordinate of a nonidentity point."""
        if not self._Z:
